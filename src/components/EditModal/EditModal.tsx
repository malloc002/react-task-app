...
import { v4 } from 'uuid';
import { buttons, closeButton, deleteButton, header, input, modalWindow, title, updateButton, wrapper } from './EditModall.css';
  ...
  return (
    <div className={wrapper}>
      <div className={modalWindow}>
        ...
        <input className={input} type='text' value={data.task.taskOwner} onChange={handleOwnerChange} />
